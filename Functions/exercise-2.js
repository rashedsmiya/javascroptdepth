...
const login = (username, password) => {
    ...
    if (username === 'moomoo' && password === "dg"){
...
const test = login("admin", "meow"); // "test" should be false
const test2 = login("admin", "lol"); // "test2" should be true
const test3 = login("monkey", "124"); // "test3" should be true
const test4 = login("moomoo", "dg"); // "test4" should be true
const test5 = login("moomoo", "moo"); // "test5" should be false
